...
import prm.projectbase.entity.Gender;
import prm.projectbase.entity.FitnessGoal;
...
public class AuthService {
    ...
    public AuthResponse register(RegisterRequest request) {
        ...
        // Save UserProfile inside the exact same database transaction!
        UserProfile profile = UserProfile.builder()
                ...
                .fitnessGoal(request.getFitnessGoal() != null ? FitnessGoal.valueOf(request.getFitnessGoal().toUpperCase()) : null)
                .fitnessLevel(request.getFitnessLevel() != null ? FitnessLevel.valueOf(request.getFitnessLevel().toUpperCase()) : null)
                .build();
